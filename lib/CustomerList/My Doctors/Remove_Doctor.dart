...
class RemoveDoctor extends StatefulWidget {
  const RemoveDoctor({super.key});

  @override
  State<RemoveDoctor> createState() => _RemoveDoctorState();
}

class _RemoveDoctorState extends State<RemoveDoctor> {
  String? drclass;
  String? drfrequency;
  ...
  Card buildClassAndFrequencyCard() {
    return Card(
      color: Colors.white,
      elevation: 4,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  '4', // Display the selected frequency
                  style: const TextStyle(
                      fontSize: 16, fontWeight: FontWeight.bold),
                ),
              ],
